"""
Harmonic Entrepreneur Survey – Complete Analysis Pipeline
==========================================================
Based on: Chapter 4 – The Harmonic Entrepreneur (Passarelli, 2024)
Survey:   UNICAL, May 2026
...
2. Place your data file in the same folder as this script:
       data_unical_2026-05-12_15-12.xlsx

3. Run:
       python harmonic_entrepreneur_analysis.py

   All outputs (CSV files + PNG charts) will be saved to the same folder.

THEORETICAL BACKGROUND
-----------------------
Each Likert item has 4 ordered options:
  1 = purely profit-driven / self-focused  (least harmonic)
  2 = transitional / partially aware
  3 = socially responsible but pragmatic
  4 = fully harmonic (integrates profit, people, wellbeing, creation)

The survey measures alignment with the Three-Pronged Diamond:
  - Salus salutis  → A1 (Personal Well-being)
  - Homo humanitas → A3 (Relationships), A2 (Ethics), A5 (Social Function)
  - Homo humus     → A4 (Innovation & Future, sustainability angle)
  Entrepreneurial orientation overall → A0 (Motivation), A6 (Self-awareness)

ANALYSIS STEPS
--------------
STEP 1  – Load & clean data
STEP 2  – Compute section scores and composite HE index
STEP 3  – Descriptive statistics
STEP 4  – Reliability (Cronbach's alpha) per section
STEP 5  – Demographic analysis (gender, age, education)
STEP 6  – Correlation matrix between sections
STEP 7  – Radar/spider chart of section score profiles
STEP 8  – Item-level response distribution charts
STEP 9  – Response time analysis (TIME_SUM)
STEP 10 – Five-words word cloud
STEP 11 – Open-text quality metrics (A7 section) – language-agnostic proxies
STEP 12 – Export clean dataset to CSV
"""
